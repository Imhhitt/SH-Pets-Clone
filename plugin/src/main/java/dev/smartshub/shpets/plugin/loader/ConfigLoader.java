package dev.smartshub.shpets.plugin.loader;
...
import dev.smartshub.shpets.plugin.storage.config.ConfigContainerImpl;
import dev.smartshub.shpets.plugin.storage.config.Configuration;
...
public class ConfigLoader {
    ...
    public ConfigLoader(Main plugin, boolean cacheEnabled) {
        this.plugin = plugin;
        this.cacheEnabled = cacheEnabled;
        loadFromFile("pets/template.yml");
    }
